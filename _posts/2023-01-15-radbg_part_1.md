...
Using this we can either signal that our process should be traced or we can attach to the program to be traced (called the *inferior*). The signals generated by the inferior are caught by the debugger. 
